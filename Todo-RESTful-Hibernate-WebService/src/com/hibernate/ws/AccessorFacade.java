...
public class AccessorFacade {
    ...
    /***
     * Date checker method that is used to assign class color. The colors will be displayed through css. 
     * @param date Requires the date in a string format. 
     * @return Returns the colors red or green, or null if not applicable. 
     */
